...
static const char type_strings[] = "a0\0a1\0a2\0a3\0acct\0action\0addr\0arch\0auid\0cap_fi\0"
	...
	"prom\0proto\0res\0resp\0result\0saddr\0sauid\0scontext\0ses\0sgid\0"
	"sig\0sigev_signo\0subj\0suid\0syscall\0tcontext\0uid\0vm\0vm-ctx\0watch";
static const unsigned type_s2i_s[] = {
	...
	571,576,582,586,591,598,604,610,619,623,
	628,632,644,649,654,662,671,675,678,685,
};
static const int type_s2i_i[] = {
	...
	11,25,13,40,13,9,1,32,21,2,
	18,18,32,1,3,32,1,6,32,6,
};
static int type_s2i(const char *s, int *value) {
	return s2i__(type_strings, type_s2i_s, type_s2i_i, 110, s, value);
}
