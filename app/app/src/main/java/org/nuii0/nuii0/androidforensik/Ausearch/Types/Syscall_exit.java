...
public class Syscall_exit extends Type {

    private final Pattern r = Pattern.compile("^.*: arch=(.*) syscall=(.*) per=(.*) a0=(.*) a1=(.*) a2=(.*) a3=(.*) items=(.*) ppid=(.*) pid=(.*) auid=(.*) uid=(.*) gid=(.*) euid=(.*) suid=(.*) fsuid=(.*) egid=(.*) sgid=(.*) fsgid=(.*) tty=(.*) ses=(.*) comm=(.*) exe=(.*) subj=(.*) key=(.*)$");
    ...
    public Syscall_exit(String raw) {
        super(raw);
        ...
        this.a2 = m.group(6);
        this.a3 = m.group(7);
        this.items = m.group(8);
        this.ppid = m.group(9);
        this.pid = m.group(10);
        this.auid    = m.group(11);
        this.uid = m.group(12);
        this.gid = m.group(13);
        this.euid    = m.group(14);
        this.suid = m.group(15);
        this.fsuid = m.group(16);
        this.egid = m.group(17);
        this.sgid = m.group(18);
        this.fsgid = m.group(19);
        this.tty = m.group(20);
        this.ses = m.group(21);
        this.comm = m.group(22);
        this.exe = m.group(23);
